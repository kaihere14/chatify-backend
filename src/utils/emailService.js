      ...
      html: `
        <div style="max-width: 600px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background-color: #ffffff; border: 1px solid #e5e5e5; border-radius: 8px; overflow: hidden;">
          ...
          <div style="padding: 30px 30px 20px 30px; text-align: center;">
            <div style="display: inline-block; background-color: #fff3cd; width: 60px; height: 60px; border-radius: 50%; margin: 0 0 20px 0; position: relative;">
              <span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: #856404; font-size: 24px;">🔐</span>
            </div>
          ...
          <div style="margin: 0 30px 30px 30px; background-color: #e8f4fd; border-left: 4px solid #007bff; padding: 20px; border-radius: 4px;">
            ...
            <p style="margin: 0; color: #495057; font-size: 14px; line-height: 1.6;">Enter this 6-digit code in the verification field on Chatify to complete your login process. The code will expire in 1 minute for your security.</p>
          </div>
          ...
          <div style="background-color: #f8f9fa; padding: 25px 30px; border-top: 1px solid #e9ecef;">
            ...
            <div style="text-align: center;">
              ...
              <p style="margin: 0; color: #6c757d; font-size: 12px;">&copy; 2024 Chatify. All rights reserved.</p>
            </div>
          </div>
        </div>
      `,
      ...
      html: `
        <div style="max-width: 600px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background-color: #ffffff; border: 1px solid #e5e5e5; border-radius: 8px; overflow: hidden;">
          ...
          <div style="padding: 40px 30px; text-align: center;">
            <div style="display: inline-block; background-color: #e8f5e8; width: 80px; height: 80px; border-radius: 50%; margin: 0 0 20px 0; position: relative;">
              <span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: #28a745; font-size: 40px; font-weight: bold;">✓</span>
            </div>
          ...
          <div style="text-align: center; padding: 0 30px 40px 30px;">
            <a href="#" style="display: inline-block; background: linear-gradient(135deg, #007bff 0%, #0056b3 100%); color: #ffffff; text-decoration: none; padding: 15px 30px; border-radius: 25px; font-size: 16px; font-weight: 600; box-shadow: 0 3px 12px rgba(0, 123, 255, 0.3);">Get Started Now</a>
          </div>
